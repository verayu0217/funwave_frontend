...
function Footer(props) {
  return (
    ...
    <div className="container-fluid footerWrapperPCMember ">
    <div className="footerOutSideMember row gx-0">
        <div className="footerUpPCMember col-12"></div>
        <div className="footerContentMember">
            <div className="d-flex justify-content-center align-items-start flex-wrap padContentFooterMember">
              ...
              <div className="col-6 col-lg-3 p-3">
                  <Figure href="/home" className="">
                    <img src={logo} className="imgLogoFooterMember " />
                  </Figure>
                  <div className="h5 fw-normal textBreakFooterMember text-wrap">此網站僅用於程式開發技術實作學習用途，如有任何侵害到您權益的問題，敬請聯繫funwave.funwave@gmail.com，我們將立即將網站做下線及相關檔案銷毀處理，非常謝謝您！</div>
              </div>
            </div>
        </div>
      </div>
