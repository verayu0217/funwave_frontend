...
function CircleLeft() {
  return (
    <div className="leftCirclePos">
      ...
      <text className="cls-2 fw-bold bsText text-nowrap">初階浪點</text>
      <text className="cls-2 fw-bold mdText text-nowrap">中階浪點</text>
      <text className="cls-2 fw-bold hgText text-nowrap">高階浪點</text>
    </div>
  );
}
